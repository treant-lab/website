...
import { ArrowRight, CheckCircle, Star, Globe, Lock, Zap, Github, Linkedin, Twitter, Mail, Phone, MapPin } from "lucide-react"
...
export default function TreantLabPage() {
  ...
  const navItems = [
    ...
    { label: t("Products.section_title"), href: "#products" },
    { label: t("Navigation.about"), href: "#about" },
    { label: t("Navigation.contact"), href: "#contact" },
  ]

  return (
    <div className="min-h-screen text-white bg-black scroll-smooth">
      {/* Global Components */}
      <ScrollProgress />
      <CustomCursor />
      <CyberBackground />
      ...
      >
        <div className="container mx-auto px-6 py-3">
          <div className="flex items-center justify-between">
            ...
            <MobileMenu
              items={navItems}
              ctaLabel={t("Navigation.request_quote")}
      ...
      <section id="products" ref={productsRef}>
        <ProductsSection activeSection={activeSection} />
      </section>
      ...
      <section id="testimonials" ref={testimonialsRef} className="relative py-20">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <TestimonialsCarousel testimonials={testimonialsData} autoPlayInterval={5000} />
        </div>
      </section>
      ...
      {/* Footer */}
      <footer id="footer" ref={footerRef} className="relative py-16 border-t border-gray-800">
        {/* Overlay do Footer */}
        <div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center space-x-2 mb-4">
                <Image src="/static/logo_head.png" alt="TreantLab Logo" width={48} height={48} className="h-12 w-auto" />
                <span className="text-xl font-bold text-white">TreantLab</span>
              </div>
              ...
              <div className="flex space-x-4">
                <a href="https://github.com/treantlab" target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-800 rounded-lg hover:bg-emerald-600/20 hover:text-emerald-400 transition-colors">
                  <Github className="w-5 h-5" />
                </a>
                <a href="https://linkedin.com/company/treantlab" target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-800 rounded-lg hover:bg-emerald-600/20 hover:text-emerald-400 transition-colors">
                  <Linkedin className="w-5 h-5" />
                </a>
                <a href="https://twitter.com/treantlab" target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-800 rounded-lg hover:bg-emerald-600/20 hover:text-emerald-400 transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-center space-x-3 text-gray-400 text-sm">
                  ...
                  <span>+55 15 99698-8717</span>
                </li>
                <li className="flex items-center space-x-3 text-gray-400 text-sm">
                  <Mail className="w-4 h-4 text-emerald-400" />
                  <span>contato@treantlab.org</span>
                </li>
                <li className="flex items-center space-x-3 text-gray-400 text-sm">
              ...
              <p className="text-gray-500 text-xs mt-4">CNPJ: 61.618.812/0001-90</p>
            </div>
          </div>
